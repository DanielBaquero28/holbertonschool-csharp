...
/// <summary> Creates a collection of objects which can be
/// iterated through a doreach loop
/// </summary>
public class Objs<T> : IEnumerable<T>
{
    /// <summary> List of objects </summary>
    public List<T> obj_list = new List<T>();
    
    /// <summary> Appends an object to the list </summary>
    public void Add(T obj)
    {
        obj_list.Add(obj);
    }

    /// <summary> Returns the list of objects of type T </summary>
    public IEnumerator<T> GetEnumerator()
    {
        return (obj_list.GetEnumerator());
    }
    /// <summary> Must also implement IEnumerable.GetEnumerator but private </summary>
